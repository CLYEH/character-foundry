...
_TABLES_TO_CLEAN = (
    "refresh_tokens",
    "tasks",
    # generation_logs has FK to users(RESTRICT) and characters(SET NULL).
    # Must precede users; T-017's worker writes here, and prior suites
    # may leave rows that block the user delete.
    "generation_logs",
    "motions",
    "aliases",
    "bases",
